...
class ModelRouter:
    ...
    def __init__(
        self,
        generator_model: str = "openrouter/google/gemini-3.5-flash",
        verifier_model: str = "openrouter/google/gemini-3.5-flash",
        diversity_model: str = "openrouter/google/gemini-3.5-flash",
        **api_keys
    ):
